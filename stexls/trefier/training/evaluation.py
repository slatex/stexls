...
def plot_confusion_matrix(
        ...
        automatically_close_figure: bool = True,
...
class Evaluation:
    def __init__(
            ...
            history_series: Tuple[str, ...] = ('loss', 'acc')):
    ...
    def plot(self, transpose_scores=True):
        ...
        if self.history is not None:
            ...
            for i, series in enumerate(self.history_series):
                ...
                plt.xlabel("Epoch")
                plt.ylabel('Accuracy' if series ==
                           'acc' else series.capitalize())
        ...
        plot_confusion_matrix(
            cm=self.evaluation['confusion_matrix'], classes=list(self.classes.values()))
        ...
        # *1.5 because there are 4 metrics and I want to position it in the center
